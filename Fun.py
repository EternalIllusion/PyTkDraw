...
def Destroy(uiName,elementName):
    if uiName in G_UIElementArray:
        try:G_UIElementArray.pop(uiName)
        except:pass
        try:G_UIElementAlias.pop(uiName)
        except:pass
        try:G_UIGroupDictionary.pop(uiName)
        except:pass
        try:G_UIStyleDictionary.pop(uiName)
        except:pass
...
#设置控件的文本(Label、Button、Entry、Text)。
...
#获取控件的文本(Label、Button、Entry、Text)。
